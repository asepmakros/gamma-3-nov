 ...
 <script src="https://code.jquery.com/jquery-3.5.1.js"></script>
  ...
  <body>
    ...
    <h1>Aplikasi Upload Resi NCS</h1>
        ...
        <form action="page/penjualan/resi/upload.php" method="post" enctype="multipart/form-data" class="mt-3">
...
<div class="container">
    ...
    <table id="myTable" class="table table-sm table-striped display">
        ...
        <?php 
            ...
            select * from tb_resi_ncs  order by id desc
            "); 
        ...
        <tr>
            <td><?= $no++ ?></td>
            <td>
            <a href="https://www.posindonesia.co.id/id/tracking/<?= $data_resi['kode'] ?>">
                <?= $data_resi['CONSIGNEE'] ?>
                </a>
            </td>
                <td><?= $data_resi['AWB'] ?></td>
<!-- AWB                <td><?= number_format($data_resi['AWB']) ?></td> -->
